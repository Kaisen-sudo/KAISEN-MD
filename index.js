    ...
    conn.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'close') {
        ...
        try {
          ...
          let up = `*HELLO THERE KAISEN-MD CONNECTED ! 👋🏻* 

*KEEP ON USING KAISEN MODS🚩* 
...
> © POWERED BY KAISEN TECH 🇭🇹`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/nbzpah.jpeg` }, caption: up })
